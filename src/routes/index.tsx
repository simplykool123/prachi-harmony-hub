...
import {
  ...
  services,
  whatsappUrl,
} from "@/components/prachi/site-data";
...
const heroLeftImage = "/site-images/prachi-hero-left.png";
const heroRightImage = "/site-images/prachi-hero-right.png";
  ...
  head: () => ({
    meta: [
      { title: "Prachi Fulfagar | Vastu, Palmistry & Astrology" },
      {
        name: "description",
        content:
          "Award-winning Vastu, Palmistry and Vedic Astrology consultant serving India and international clients.",
      },
      { property: "og:title", content: "Prachi Fulfagar | Ancient Wisdom for Harmony" },
      {
        property: "og:description",
        content: "Premium Vastu, Palmistry and Vedic Astrology consultations in India and worldwide.",
      },
    ],
  }),
  component: Index,
...
const impactItems = [
  [
    "Health",
    "Restful rooms, balanced elements and less environmental stress support calmer daily routines.",
    "sunrise",
  ],
    ...
    <div className={`pointer-events-none ${className}`} aria-hidden="true">
      <div className="relative h-full w-full">
        ...
        <div className="pf-png-moon-orbit absolute inset-0">
          <img
            src={celestialMoonImage}
            alt=""
            loading="lazy"
            decoding="async"
            className="absolute left-1/2 top-[1%] h-[24%] w-[24%] -translate-x-1/2 -translate-y-1/2 object-contain"
          />
        </div>
      </div>
    </div>
    ...
    return (
      <div className="relative h-32 w-32 shrink-0 text-accent/70">
        ...
        <div className="absolute bottom-2 right-4 flex items-end gap-1.5">
          {[28, 44, 62, 82].map((height) => (
            <span key={height} className="w-3 border border-current" style={{ height }} />
          ))}
        </div>
      </div>
    );
    ...
    <>
      <MotionSection className="relative overflow-hidden bg-background py-9">
        <div className="pf-container relative z-10">
          <SectionIntro
            ...
            title="Services for every space and soul"
            copy="From your palm to your home — a complete system of ancient wisdom."
          />
          ...
          <div className="mt-5 text-center">
            <Link to="/services" className="text-[12px] font-medium text-accent underline-offset-4 hover:underline">
              See all 12 services →
            </Link>
          </div>
        </div>
        ...
        <div className="pf-container relative overflow-hidden py-3">
          <div className="grid items-center gap-10 lg:grid-cols-[56fr_44fr] lg:gap-12">
            <div className="relative z-10">
              ...
              <h2 className="pf-h2 mt-7 max-w-[480px]">
                Small corrections that feel <em className="font-heading font-light italic text-accent">possible</em>
              </h2>
              <p className="pf-body mt-5 max-w-[460px]">
                Prachi’s work is solution-oriented — many improvements begin with simple placements, light, colour and
                element balance.
              </p>
              <div className="mt-9 grid gap-y-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-y-0">
                {remedyHighlights.map((item) => {
                  return (
                    <article key={item.title} className="pf-remedy-item px-3 text-center first:pl-0 last:pr-0">
                      ...
                      <p className="mx-auto mt-4 max-w-[150px] text-[12px] font-light leading-relaxed text-muted-foreground">
                        {item.description}
                      </p>
                    </article>
                  );
            ...
            <div className="pf-remedy-visual relative z-10 mx-auto w-full max-w-[430px] py-8 lg:py-0">
              <div className="pf-remedy-image-shell relative z-10 h-[360px] w-full">
                <img
                  src={homeRemediesImage}
                  alt="Practical Vastu home remedy with flowers and water in a real living room"
                  width={1280}
                  height={960}
                  loading="lazy"
                  decoding="async"
      ...
      <MotionSection className="relative overflow-hidden bg-warm py-8">
        <img
          ...
          loading="lazy"
          decoding="async"
          className="pf-process-side-image left-4 top-6 h-24 w-24 md:left-10 md:h-32 md:w-32"
        />
        <img
          src={celestialRingImage}
          alt=""
          loading="lazy"
          decoding="async"
          className="pf-process-side-image bottom-6 right-4 h-28 w-28 md:right-10 md:h-36 md:w-36"
        />
        <div className="pf-container relative z-10">
            ...
            {processItems.map((item, index) => {
              ...
              return (
                <div key={item.label} className="pf-process-step relative flex flex-col items-center text-center">
                  ...
                  <span className="mt-2 font-heading text-[23px] font-light leading-none text-accent/30">
                    0{index + 1}
                  </span>
                  <p className="mt-0.5 font-heading leading-none text-foreground text-lg font-normal">{item.label}</p>
                  <p className="mx-auto mt-1.5 max-w-[175px] text-[12px] font-light leading-snug text-muted-foreground">
                    {item.copy}
                  </p>
                </div>
              );
      ...
      <MotionSection className="relative overflow-hidden bg-card py-12">
        <div className="pf-container relative z-10 grid items-center gap-10 lg:grid-cols-[31fr_38fr_31fr]">
          <div className="pf-about-portrait-wrap relative mx-auto min-h-[440px] w-full max-w-[320px]">
            ...
            <span className="pf-about-arch-moon" aria-hidden="true">
              ☾
            </span>
            <div className="pf-about-image-frame pf-about-image-arch absolute inset-x-0 top-0 mx-auto h-[430px] w-[88%]">
              <img
                src={prachiPortraitImage}
                alt="Prachi Fulfagar in her Vastu and Palmistry consultation studio"
                width={900}
                height={1350}
                loading="lazy"
                decoding="async"
          ...
          <div className="text-center lg:self-center">
            ...
            <p className="pf-body mx-auto mt-5 max-w-[430px]">
              Prachi Fulfagar is one of India's most credentialled Vastu and Palmistry consultants — combining both in a
              rare integrated practice that aligns you from the inside out.
            </p>
            <p className="pf-body mx-auto mt-4 max-w-[430px]">
              Consulting from Mumbai, Pune, Nashik and Kopargaon, she works with clients across India and
              internationally.
            </p>
            <Link to="/about" className="group mt-7 inline-flex text-[13px] font-medium text-accent">
              Read her full story <span className="transition group-hover:translate-x-1">→</span>
            </Link>
          </div>
          <div className="pf-about-side-wrap relative mx-auto min-h-[430px] w-full max-w-[330px]">
            <div className="pf-about-image-frame pf-about-image-soft absolute inset-x-0 bottom-0 mx-auto h-[385px] w-[92%]">
              <img
                ...
                alt="Palmistry and astrology consultation details"
                width={1120}
                height={1328}
                loading="lazy"
                decoding="async"
      ...
      <MotionSection className="relative overflow-hidden bg-background py-16">
        <img
          src={vastuPlanImage}
          alt="Faint Vastu plan background"
          width={960}
          height={655}
          loading="lazy"
          decoding="async"
          className="absolute left-0 top-0 h-full w-[46%] object-cover opacity-[0.08]"
        />
        <CelestialMotion className="absolute right-[6%] top-10 hidden h-[166px] w-[166px] lg:block" />
        <div className="pf-container relative z-10">
          <SectionIntro
            eyebrow="BEFORE & AFTER"
            title="The impact of alignment"
            copy="The goal is not decoration — it is a home or workplace that starts supporting the life inside it."
          />
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {impactItems.map(([title, copy, type], index) => (
              <article
                key={title}
                className="pf-card grid min-h-[178px] grid-cols-[1fr_auto] items-center gap-4 overflow-hidden p-5"
              >
                <div>
      ...
      <MotionSection className="relative overflow-hidden bg-card py-14">
        ...
        <div className="pf-container relative z-10">
          <SectionIntro
            eyebrow="AUTHORITY"
            title="Awards, recognition and global reach"
            copy="A trusted practice serving Indian and international clients with recognised expertise."
          />
          <div className="mt-9 grid gap-4 lg:grid-cols-2">
            {awards.map((award, index) => {
              const Icon = award.icon;
              return (
                <article key={award.title} className="pf-card grid gap-4 p-5 sm:grid-cols-[auto_1fr]">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-badge text-accent">
                    <Icon size={20} strokeWidth={1.6} />
                  </div>
                  <div>
                    <p className="text-[9px] font-medium uppercase tracking-[2px] text-accent">
                      Recognition 0{index + 1}
                    </p>
                    <h3 className="pf-h3 mt-2">{award.title}</h3>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-2.5">
            {globalPresence.map((place) => (
              <span
                key={place}
                className="rounded-full border border-border bg-card-soft px-4 py-2 text-[11px] text-muted-foreground"
              >
                {place}
              </span>
            ))}
      ...
      <MotionSection className="relative overflow-hidden bg-background py-16">
        <img
          src={celestialPalmImage}
          alt="Palmistry background for client stories"
          width={759}
          height={900}
          loading="lazy"
          decoding="async"
          ...
          <div className="pf-story-marquee mt-14 overflow-hidden">
            <div className="pf-story-track flex w-max gap-5">
              {[...customerStories, ...customerStories].map((story, index) => (
                <article
                  key={`${story.name}-${story.role}-${index}`}
                  className="pf-card w-[310px] shrink-0 overflow-hidden p-0 sm:w-[360px]"
                >
      ...
      <MotionSection className="relative min-h-[520px] overflow-hidden border-y border-border bg-warm pb-20 pt-28 text-center">
        ...
        <div className="pf-container relative z-10 pt-20">
          ...
          <p className="pf-body mx-auto mt-4 max-w-xl">
            Book a consultation — in person or online, across India and internationally.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-3.5">
            <Button asChild variant="hero">
              <Link to="/contact">Book a Session</Link>
            </Button>
            <Button asChild variant="porcelain">
